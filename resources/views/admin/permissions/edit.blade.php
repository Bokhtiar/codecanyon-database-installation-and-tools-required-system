    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-600 mt-2">Update permission details</p>
            </div>
            ...
            <form action="{{ route('admin.permissions.update', $permission) }}" method="POST">
                ...
                <div class="px-4 py-5 sm:p-6 space-y-6">
                    ...
                    <div class="bg-blue-50 rounded-lg p-4">
                        <h4 class="text-sm font-medium text-blue-900 mb-3">Current Usage Information</h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div>
                                <strong class="text-blue-700">Assigned to Roles:</strong>
                                <div class="mt-1">
                                    ...
                                    @empty
                                        <span class="text-blue-600">No roles assigned</span>
                                    @endforelse
                                </div>
                            </div>
                            <div>
                                <strong class="text-blue-700">Created:</strong>
                                <p class="text-blue-600">{{ $permission->created_at->format('M d, Y H:i') }}</p>
                                <strong class="text-blue-700">Last Updated:</strong>
                                <p class="text-blue-600">{{ $permission->updated_at->format('M d, Y H:i') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
